  ...
  const getPreviewContent = () => {
    if (accountType === 'doctor') {
      ...
      return {
        ...
        description: 'Book home visits, consult verified doctors, and manage health records.',
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
          </svg>
        ),
        features: ['Book Home Visits', 'Manage Addresses', 'Add Family Members', 'View Prescriptions'],
      };
    } else {
      return {
            ...
            <div className="mb-6">
              <div className="flex bg-gray-100 rounded-lg p-1 flex-wrap md:flex-nowrap gap-1">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-md transition-all text-sm ${
                    accountType === 'patient'
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="flex gap-3 flex-wrap sm:flex-nowrap">
                  <Link
                    ...
                    className="flex-1 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-center font-medium text-sm whitespace-nowrap"
                  >
                    Patient
                  </Link>
                  <Link
                    href="/register/doctor"
                    className="flex-1 px-3 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors text-center font-medium text-sm whitespace-nowrap"
                  >
                    Doctor
                  </Link>
                  <Link
                    href="/register/hospital"
                    className="flex-1 px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-center font-medium text-sm whitespace-nowrap"
                  >
                    Hospital
                  </Link>
                </div>
